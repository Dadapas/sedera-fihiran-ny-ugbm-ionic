...
myApp.controller('SederaCtrl', function ($scope) {
    /*
     * Tous les listes de sedeara sont appiqué ici
...
myApp.controller('HiraCtrl', function ($scope) {
    /*
